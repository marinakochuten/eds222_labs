...
2.  What does the intercept tell you, in words?
    ...
    -   B0 = 35.79, which is the mpg of car in 1999 with impossibly small engine

        -   In 1999, for engine size 0 (displ = 0), the mpg is 35.79

        -   mpg for a size 0 car in 1999

3.  What does the coefficient on `displ` tell you, in words?

    -   B1 = -3.7684 - in 1999, as engine size increases 1 unit, mpg decreases -3.7689 mpg

        -   

4.  What does the coefficient estimate on the 2008 vintage indicator variable (`year2008`) tell you, in words?

    -   B2 = 0.3445, which is how much the mpg increases for cars in 2008 from 1999 with an impossibly small engine

5.  What does the coefficient on `displ:year2008` tell you, in words?[^week-4-lab-1]

    -   B3 = 0.3052, the slope of the line for 2008 is 0.3052 more positive than the line in 1999
...
```{r}
mod3 <- augment(mod2)
ggplot(mod3, aes(x = displ, y = hwy, color = year)) +
  geom_point() +
  # (x2 = 0 OR year = 1999)
